...
本文档整合当前项目的架构、目录、文件职责、数据存储与核心流程，替代/汇总以下分散说明：

- `docs/存储模式说明.md`
- `docs/小说工作台模式与脚本规范.md`
- `工作流脚本/README.md`
- `工作流脚本/流程接口契约.md`
- `docs/流程简述.txt`
...
| `docs/技术文档.md` | 本文档：架构、目录、文件职责、数据存储、流程 |
| `docs/完整流程与选择规范.md` | 面向业务/生成模型的完整流程与格式规范 |
| `docs/存储模式说明.md` | 项目存储模式（保留旧说明，以本文档 5 节为准） |
| `docs/小说工作台模式与脚本规范.md` | 三种模式与脚本规范说明 |
| `工作流脚本/流程接口契约.md` | `/api/workflow/run` 接口契约与任务表 |
| `工作流脚本/README.md` | Python 工作流脚本说明 |
